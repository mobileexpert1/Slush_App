...
//-----------------------------------------
        ...
        Timer(const Duration(seconds: 1),() {
          ...
          Get.showSnackbar(
            GetSnackBar(
              ...
              messageText: Stack(
                children: [
                  SizedBox(height: 70, child: SvgPicture.asset(AssetsPics.bannerheart, fit: BoxFit.cover, width: double.infinity)),
                  Container(
                    height: 60,
  ...
  void startTimer() {
    countdownTimer = Timer.periodic(Duration(seconds: 1), (timer) {setCountDown();});
  }
...
class eventController extends ChangeNotifier{
  ...
  int _timeRemain=0;
  int get timeRemain=>_timeRemain;
...
//-----------------------------------------
  ...
  String? timestampString; /// before 15 min
  ...
  void setDateFormatForApi(int duration,context) {
    ...
    beforeFifteenMinutes(duration); /// 15 min time of the event start
            ...
            titleText: Stack(
              ...
              children: [
                ...
                Container(
                    ...
                    child: buildText2('Event starting in ${min} minutes, Click Here\nto join the waiting room!', 18, FontWeight.w600,color.txtWhite)),
              ],
            ),
  ...
  void setCountDown() {
    ...
    _minutes = strDigits(_myDuration!.inMinutes.remainder(60));
    _seconds = strDigits(_myDuration!.inSeconds.remainder(60));
    if(_myDuration!.inSeconds % 60 ==0 && seconds<900 && seconds>2 ) {Get.snackbar('', '',
          duration: const Duration(seconds: 5),
          snackPosition: SnackPosition.TOP,
          margin: EdgeInsets.zero,
          padding: EdgeInsets.zero,
          ...
          titleText: Stack(
            ...
            children: [
              ...
              Container(
                  padding: const EdgeInsets.only(top: 0,left: 10,right: 10,bottom: 15),
                  child: buildText2('Event starting in ${strDigits(_myDuration!.inMinutes.remainder(60))} minutes, Click Here\nto join the waiting room!', 18, FontWeight.w600,color.txtWhite)),
            ],
          ),
          shouldIconPulse: true,
          // maxWidth: MediaQuery.of(context).size.width,
