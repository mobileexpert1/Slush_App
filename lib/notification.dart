...
bool checkIfLastTwoWordsAreLikedYou(String sentence) {return sentence.toLowerCase().endsWith('liked you.');}
...
//           // onDidReceiveLocalNotification: (int id, String? title, String? body, String? payload) async {print("sasasassa");}
//         ));
