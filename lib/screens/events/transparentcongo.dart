...
Widget stackbuild(BuildContext context,String name,int userId){
  final size=MediaQuery.of(context).size;
  return Stack(children: [
    Container(height: size.height, width: size.width, color: Colors.black.withOpacity(0.9)),
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          buildText2("“${name} liked you back”", 16, FontWeight.w500, color.txtWhite,fontFamily: FontFamily.hellix),
          // const SizedBox(height: 20),
          // SvgPicture.asset("assets/sample/matchingSample.svg"),
