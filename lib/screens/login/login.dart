...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // appBar: commonBarWithTextleft(context,Colors.transparent,"Version:1.0(3)"),
      body: Stack(
        children: [
          SizedBox(
            height: size.height,
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildText(LocaleText.signIn, 16, FontWeight.w500, Colors.black,fontFamily: FontFamily.hellix),
                    SizedBox(height: 4.h),
                    Padding(
                    ...
                    buildContainer("Enter email",loginController,AutovalidateMode.onUserInteraction,loginFocus,
                      validation: (value) {
                        if (value == null || value.isEmpty) {
                          return '';
                        } else if (!RegExp(LocaleKeysValidation.email).hasMatch(value)) {
                          return '';
                        } else {
                          return null;
                        }
                    ...
                    buildContainer("Enter password",passwordController,AutovalidateMode.onUserInteraction,passwordFocus,
                      obs: password, validation: (value) {
                        if (value == null || value.isEmpty) {
                          return '';
                    ...
                    Container(padding: const EdgeInsets.only(top: 15),
                        ...
                        child: GestureDetector(
                            ...
                            ,child: buildText2("Forgot password ?", 16, FontWeight.w500, color.txtBlack,fontFamily: FontFamily.hellix))),
                    const SizedBox(height: 30),
                    blue_button(context,"Login",validation: button,press: (){
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        buildCircleAvatar(AssetsPics.facebook,(){lgincntrl.loginWithFacebook();}),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(onTap: (){
                            Get.off(()=>const CreateNewAccount());
  ...
  Widget buildColorContainer(Color clr1,Color clr2) {
    return Expanded(
      child: Container(
        // width: 100,
        height: 4,decoration: BoxDecoration(gradient: LinearGradient(colors: [clr1, clr2])),),
    );
  }
  ...
  Widget buildCircleAvatar(String img,onTap) {
    return GestureDetector(
        onTap: onTap,
        child: CircleAvatar(radius: 25, backgroundColor: color.txtWhite,child: Image.asset(img,height: 23),));
  }

  Widget buildTextSpan2(String txt,Color clr) {
    return Text( txt,style: TextStyle(color: clr,fontWeight: FontWeight.w500,fontSize: 16,fontFamily: FontFamily.hellix));
  }

  Widget buildContainer(String txt, TextEditingController controller, AutovalidateMode auto,FocusNode node,
      {FormFieldValidator<String>? validation,VoidCallback? press,GestureDetector? gesture, bool obs=false}) {
    return Align(
      alignment: Alignment.center,
      child: Container(
        ...
        child: TextFormField(
          ...
          onChanged: (val) {
            setState(() {
              if (_form.currentState!.validate()) {button = true;}
              else {button = false;}
            });
          },
