  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        _showNotification? CustomredTopToaster(textt: "Keep it clean. No explict content"):const SizedBox.shrink()
      ],
    );
  }
          ...
          Expanded(child: Stack(fit: StackFit.expand,
                children: [
                  Container(
                      ...
                      ? Consumer<editProfileController>(builder: (context,val,child) {return val.controller==null ? const SizedBox():
                        buildVideoContainer(val.controller!,val.initializeVideoPlayerFuture!);}) : buildContainer()),
                  Container(padding: const EdgeInsets.only(right: 5, top: 5), alignment: Alignment.topRight,
                      child: SvgPicture.asset(AssetsPics.zoomIcon, fit: BoxFit.cover)),
                  Positioned(right: 0.10, bottom: 0.0,
                    child: GestureDetector(
                      onLongPress: () {
                        if (imgdata["profileVideos"].length != 0) {buildCustomDialogBoxWithtwobuttonfordeletePicture(0,"video");}
                      },
                      onTap: () {buildShowModalBottomSheet("video");},
              ...
              Stack(
                children: [
                  Container(
                      ...
                      ?Consumer<editProfileController>(builder: (context,val,child){
                        return  val.controller2==null ? const SizedBox(): buildVideoContainer(val.controller2!, val.initializeVideoPlayerFuture2!);})
              ...
              Stack(
                children: [
                  Container(
                      ...
                      ? Consumer<editProfileController>(builder: (context,val,child){
                        return val.controller3==null ? const SizedBox():
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(alignment: Alignment.bottomRight,
                          child: SvgPicture.asset(imgdata["profileVideos"].length >= 3?AssetsPics.profileEdit1:AssetsPics.addImage, width: 35, height: 35)),
                    ),
                  )
                ],
              ),
          ...
          child: StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
            ...
            color: Colors.transparent,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          buildText("Choose from Gallery", 18,
                          ...
                          CircleAvatar(
                            ...
                            child: CircleAvatar(
                              ...
                              // backgroundImage: SvgPicture.asset(AssetsPics.arrowLeft),
                              child: selcetedIndex == "1" ? SvgPicture.asset(AssetsPics.blueTickCheck, fit: BoxFit.cover)
                                  : const SizedBox(),
                            ),
                          )
                        ],
