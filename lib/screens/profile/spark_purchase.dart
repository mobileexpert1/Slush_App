        ...
        children: [
          Row(children: [
            GestureDetector(
              ...
              child: buildContainer(context, "1", _products.isEmpty?"...":_products[sprk1].price),
            ),
            GestureDetector(
              onTap: (){setState(() {selectedIndex=2;
              selectedIndexx=Platform.isAndroid?"3spark":"three_spark";
              ...
              child: buildContainer(context, "3", _products.isEmpty?"...":_products[sprk2].price),
            ),
            GestureDetector(
              onTap: (){setState(() {selectedIndex=3;
              selectedIndexx=Platform.isAndroid?"5spark":"five_spark";
              ...
              child: buildContainer(context, "5", _products.isEmpty?"...":_products[sprk3].price),
            ),
          ],),
          selectedIndex==2? GestureDetector(
            onTap: () {
