...
class _ViewProfileScreenState extends State<ViewProfileScreen> {
  ...
  var hi = 0.0;
  String jobTitle = LocaleHandler.dataa["jobTitle"] == null ? "" : LocaleHandler.dataa["jobTitle"];
  ...
  void addImgVid(){
    for(var i=0;i<LocaleHandler.dataa["profilePictures"].length;i++) {
      var ii={"key":"photo", "url":LocaleHandler.dataa["profilePictures"][i]["key"]};
      imgvideitems.add(ii);
    }
    for(var i=0;i<LocaleHandler.dataa["profileVideos"].length;i++) {
      var ii={"key":"video", "url":LocaleHandler.dataa["profileVideos"][i]["key"]};
      imgvideitems.add(ii);
    }
  }
                ...
                GestureDetector(
                  onTap: () {
                    Provider.of<editProfileController>(context,listen: false).saveValue(LocaleHandler.dataa["gender"],
                        LocaleHandler.dataa["height"],LocaleHandler.dataa["jobTitle"]??"",
                        LocaleHandler.education,LocaleHandler.dataa["sexuality"]??"",LocaleHandler.dataa["ideal_vacation"]??"",
                        LocaleHandler.dataa["cooking_skill"]??"",   LocaleHandler.dataa["smoking_opinion"]??""
                    );
                  ...
                  child: Stack(
                    ...
                    children: [
                      PageView.builder(
                        ...
                        onPageChanged: (indexx) {setState(() {currentPage = indexx;});
                            ...
                            children: List<Widget>.generate(
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(20),
                                  border: Border.all(
                                    color: indicatorIndex == index ? Colors.blue : Colors.white,
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          FittedBox(
                            child: buildTextOverFlow(LocaleHandler.dataa['firstName'] == null ? "" : "${LocaleHandler.dataa["firstName"] ?? ''}",
                                24, FontWeight.w600, color.txtBlack)),
                          buildTextOverFlow(", ${LocaleHandler.dataa['dateOfBirth'] == null ? "" : calculateAge(LocaleHandler.dataa['dateOfBirth'] ?? '')}",24, FontWeight.w600, color.txtBlack),
                          const SizedBox(width: 70,)
                          // SvgPicture.asset(AssetsPics.verifywithborder),
                        ],
                      ),
                      jobTitle==""?const SizedBox():  buildText("$jobTitle", 15, FontWeight.w500, color.txtgrey, fontFamily: FontFamily.hellix),
                      Wrap(
                        crossAxisAlignment: WrapCrossAlignment.center,
                        children: [
                          splitted.contains("gender")
                              ? Container(margin: const EdgeInsets.symmetric(horizontal: 2),
                                  child: SvgPicture.asset(gender == "male" ? AssetsPics.greyman : gender == "female"
                          ...
                          splitted.contains("height")? buildText(LocaleHandler.dataa["height"] + "cm", 15,
                          ...
                          splitted.contains("sexuality")? buildText(LocaleHandler.dataa["sexuality"], 15,
                              FontWeight.w500, color.txtgrey, fontFamily: FontFamily.hellix):const SizedBox(),
                          ...
                          for (var ii = 0; ii < LocaleHandler.dataa["ethnicity"].length; ii++)
                            Wrap(
                              crossAxisAlignment: WrapCrossAlignment.center,
                              children: [
                                buildText(LocaleHandler.dataa["ethnicity"][ii]["name"],
                                    15, FontWeight.w500, color.txtgrey, fontFamily: FontFamily.hellix),
                                ii== LocaleHandler.dataa["ethnicity"].length-1?const SizedBox(): Container(margin: const EdgeInsets.symmetric(horizontal: 5),
                                    child: SvgPicture.asset(AssetsPics.greydivider, height: 15)),
                      ...
                      splitted.contains("lookingFor")?  Row(
                        children: [
                          ...
                          buildText(LocaleHandler.dataa["lookingFor"] ?? '', 15,
                              FontWeight.w500, color.txtgrey, fontFamily: FontFamily.hellix),],):const SizedBox(),
                      SizedBox(height: 2.h),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          //       buildText("1 km", 15, FontWeight.w600, color.txtBlue, fontFamily: FontFamily.hellix)
                          //     ],
                          //   ),
                          // )
                        ],
                      ...
                      // buildText("${LocaleHandler.dataa["address"] ?? ''}".split(",").last,
                      // buildText(printme(LocaleHandler.dataa["address"]), 15, FontWeight.w500, color.txtgrey, fontFamily: FontFamily.hellix),
                      ...
                      Container(height:LocaleHandler.dataa["bio"]==null?0: 2.h),
                       buildText(LocaleHandler.dataa["bio"]==null?"":"About", 20, FontWeight.w600, color.txtBlack),
                      ...
                      LocaleHandler.dataa["bio"]==null?const SizedBox(): ExpandableText(
                      ...
                      SizedBox(height:LocaleHandler.dataa["bio"]==null?0: 2.h),
                      LocaleHandler.dataa["ideal_vacation"] != null|| LocaleHandler.dataa["cooking_skill"] != null|| LocaleHandler.dataa["smoking_opinion"] != null? buildText("More about me", 20, FontWeight.w600, color.txtBlack)
                      : const SizedBox(),
                      LocaleHandler.dataa["ideal_vacation"] != null|| LocaleHandler.dataa["cooking_skill"] != null|| LocaleHandler.dataa["smoking_opinion"] != null?
                      Wrap(children: [ LocaleHandler.dataa["ideal_vacation"] == null ? const SizedBox()
                              : Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      buildText(LocaleHandler.dataa["ideal_vacation"], 16, FontWeight.w600, color.txtBlack),
                                    ],
                                  ),
                                ),
                              ...
                              : Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      buildText(LocaleHandler.dataa["cooking_skill"], 16, FontWeight.w600, color.txtBlack),
                                    ],
                                  ),
                                ),
                              ...
                              : Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      buildText(LocaleHandler.dataa["smoking_opinion"], 16, FontWeight.w600, color.txtBlack),
                                    ],
                                  ),
                                ),
                        ],
                      ):const SizedBox(),
                      SizedBox(height:LocaleHandler.dataa["interests"].length==0?0: 2.h),
                      LocaleHandler.dataa["interests"].length==0?const SizedBox(): buildText("Interests", 20, FontWeight.w600, color.txtBlack),
                      LocaleHandler.dataa["interests"].length==0 ? const SizedBox()
                          : Wrap(children: [
                                ...
                                for (var i = 0; i < LocaleHandler.dataa["interests"].length; i++)
                                  Container(
                                    ...
                                    child: buildText(LocaleHandler.dataa["interests"][i]["name"], 16, FontWeight.w600, color.txtBlack),
                                  )
                                /*        FutureBuilder(future: getINterest(),
                      builder:(context, AsyncSnapshot snapshot){
                        ...
                        child: buildText("data[i][]", 16, FontWeight.w600, color.txtBlack));
                      }
                        )*/
                                /* for(Map i in data)Container(
                            margin: const EdgeInsets.only(top: 10,right: 10),
                            padding: const EdgeInsets.symmetric(horizontal: 16,vertical: 6),
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(19),
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          children: [
                            Expanded(child: LocaleHandler.dataa["profilePictures"].length == 0
                                    ? SizedBox( height: size.height*0.3,child: buildContainer()) : SizedBox( height: size.height*0.3,child: buildPhotoContainer(LocaleHandler.dataa["profilePictures"][0]["key"],0))),
                            const SizedBox(width: 10),
                            Column(
                              children: [
                                Expanded(
                                  child: SizedBox(width: size.width / 2 - 80,
                                ...
                                Expanded(
                                  child: SizedBox(
                                    ...
                                    child: LocaleHandler.dataa["profilePictures"].length >= 3
                                        ? buildPhotoContainer(LocaleHandler.dataa["profilePictures"][2]["key"],2)
                                        : buildContainer(),
                                  ),
                                ),
                              ],
  ...
  Widget buildPhotoContainer(String img,int i) {
    return GestureDetector(
      onTap: (){
        // Get.to(()=>ImageViewScreen(indexId: i, pictureItems: LocaleHandler.dataa["profilePictures"]));
