...
class _AccountSettingsState extends State<AccountSettings> {
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        buildText(
                                            notificationSetting[index].title,
                                            18,
                                            FontWeight.w600,
                                            color.txtBlack),
                                        const SizedBox(height: 5),
                                        buildText(
                                            notificationSetting[index].subTitle,
                                            16,
                                            FontWeight.w500,
                                            color.txtgrey,
                                    ...
                                    notificationSetting[index].title == "Biometric or face"
                                      ...
                                      child: Container(
                                        ...
                                        CustomAnimatedToggleSwitch<bool>(
                                            current: isSwitch,
                                            values: [false, true],
                                            indicatorSize: Size.square(26.0),
                                            ...
                                            onTap: (_) => setState(() {isSwitch = !isSwitch;
  ...
  void callNavigationFunction(int i) {
         if (i == 0) {Get.to(() => ChangePassword());}
    else if (i == 2) {Get.to(() => DeactivateProfile());}
    else if (i == 3) {Get.to(() => DeleteProfile());}
    else {}
  }
}
