...
class _DetailNameScreenState extends State<DetailNameScreen> {
  ...
  void initState() {
    nameNode.addListener(() {
      if(nameNode.hasFocus){enableField="Enter FirstName";}
      else{enableField="";}
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      buildText2("Let's setup your profile.", 28, FontWeight.w600, color.txtBlack),
      const SizedBox(height: 8),
      buildText("What’s your first name?", 16, FontWeight.w500, color.txtBlack,fontFamily: FontFamily.hellix),
       SizedBox(height: 4.h-1),
        Padding(padding: const EdgeInsets.only(left: 4,bottom: 4),
          child: buildText(" First name", 16,FontWeight.w500,enableField =="Enter FirstName"? color.txtBlue:color.txtgrey,fontFamily: FontFamily.hellix),
        ),
        buildContainer("First name", nameController, AutovalidateMode.onUserInteraction, nameNode,
          press: (){setState(() {enableField = "Enter FirstName";});},
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            CircleAvatar(radius:3.0,backgroundColor: color.green),
            buildText(" This is how it will appear in ", 14, FontWeight.w500, color.txtBlack,fontFamily: FontFamily.hellix),
            buildText("Slush.", 14, FontWeight.w600, color.txtgrey,fontFamily: FontFamily.hellix),
          ],),
