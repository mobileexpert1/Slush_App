...
class _ReadyToCallScreenState extends State<ReadyToCallScreen> {
  ...
  callFunction() async {
    ...
    // Provider.of<waitingRoom>(context).updateFixtureStatus(LocaleHandler.eventParticipantData["participantId"], "JOINED");
    updateFixtureStatus(LocaleHandler.eventParticipantData["participantId"], "JOINED");
  }
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      buildText(widget.data["firstName"], 18, FontWeight.w600,
                          color.txtBlack),
                    ],
                  ),
                  // const SizedBox(height: 55),
                  Container(height: size.height * 0.06),
                  buildText(
                      "Date number ${LocaleHandler.dateno} out of ${LocaleHandler.totalDate}",
                      20,
                      FontWeight.w600,
                      color.txtBlack),
                  const SizedBox(height: 15),
                  SizedBox(
                    width: 280,
                    child: buildText2(
                        " “Keep the sparks flying with our app - Slush!”",
                        16,
                        FontWeight.w500,
                        color.txtBlack,
                        fontFamily: FontFamily.hellix),
                        ...
                        if (!snapshot.hasData || !snapshot.data!.exists) {return buildSizedBox();}
                          ...
                          if (data['callstatus'] == "wait" && data['createdUserId'] != LocaleHandler.userId) {
                            WidgetsBinding.instance.addPostFrameCallback((_) {
                              if (onlyonce) {
                                onlyonce = false;
                                customDialogBoxwithtitle(context, LocaleText.guidetext2,
                                    "Join Now", AssetsPics.guide2, isPng: true, onTap: () {
                                  Get.back();
                            ...
                            return SizedBox(
                                ...
                                child: const Text('please wait for second person response'));
                            ...
                            WidgetsBinding.instance.addPostFrameCallback((_) {
                              ...
                              _timer.cancel();
                              Future.delayed(const Duration(minutes: 2),(){FireStoreService().deleteCallStatusToPicked();});
                            });
                          }
                        }
                        return buildSizedBox();
                    ...
                    children: <Widget>[
                      ...
                      Text.rich(
                          ...
                          TextSpan(children: [
                            ...
                            buildTextSpan(
                                'button  below in order to begin your date.\n ',
                                color.txtgrey),
                          ])),
                      const SizedBox(height: 15),
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(children: [
                Container(height: size.height*0.04),
                Container(margin: const EdgeInsets.only(top: 20), alignment: Alignment.topRight, child: SvgPicture.asset(AssetsPics.notificationI)),
                // Container(height: 20),
                Container(height: size.height*0.02),
                buildText("Speed Date", 28, FontWeight.w600, color.txtBlack),
                const SizedBox(height: 15),
                ...
                Stack(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        RotationTransition(turns:  const AlwaysStoppedAnimation(-7 / 360),
                            child: Container(decoration:BoxDecoration(color: Colors.white54, borderRadius: BorderRadius.circular(40)),
                                padding: const EdgeInsets.all(4), height: 20.h, width: 19.h,
                ...
                Row(
                  ...
                  children: [
                    // buildText("Steve", 18, FontWeight.w600, color.txtBlack),
                    buildText(LocaleHandler.name, 18, FontWeight.w600, color.txtBlack),
                    SizedBox(width: size.width*0.3),
                    // buildText("Maria", 18, FontWeight.w600, color.txtBlack),
                ...
                // const SizedBox(height: 55),
                Container(height: size.height*0.06),
                buildText("Date number ${LocaleHandler.dateno} out of ${LocaleHandler.totalDate}", 20, FontWeight.w600, color.txtBlack),
                const SizedBox(height: 15),
                SizedBox(
                  width: 280,
                ...
                SizedBox(height: size.height*0.02),
                white_button(context, "Leave Event",press: (){
                  customSparkBottomSheeet(context,AssetsPics.guide2,
