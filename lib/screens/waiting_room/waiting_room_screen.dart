                        ...
                        center: Column(
                          children: [
                            Container(height: size.height*0.05),
                             buildText2(formatDuration(Duration(seconds: widget.min)), 36, FontWeight.w700, color.txtBlack),
                              ...
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                      ...
                                      style: const TextStyle(
                                          fontSize: 16, color: color.txtBlue, fontWeight: FontWeight.w600,
                                          fontFamily: FontFamily.baloo2))
                                ],
                              ),
                            ),
                        ...
                        child: Column(
                          children: [
                            ...
                            buildText("Waiting and not sure what to do?", 16,
                                FontWeight.w500, color.txtBlack, fontFamily: FontFamily.hellix),
                            ...
                            blue_button(context, "Event guide", press: () {
                              ...
                              customDialogWithPicture(context, "Ok", heading: "",
                                  onTap: onPress,
                            ...
                            children: List<Widget>.generate(3, (int index) {
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: indicatorIndex == index ? Colors.blue : Colors.grey,
...
class _WaitingRoomState extends State<WaitingRoom> with SingleTickerProviderStateMixin {
  ...
  void startTimer() {
    _timer = Timer.periodic(const Duration(seconds: 1), (timer) {
      ...
      if(widget.min < 300){
        Get.off(() => WaitingCompleted(data: widget.data, min: min));
      }
      });
      } else {_timer.cancel();
      Get.to(() => WaitingCompleted(data: widget.data, min: min));
                            ...
                            RichText(
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                      text: widget.data["totalParticipants"].toString(),
                                      style: const TextStyle(fontSize: 16, color: color.txtBlue,
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          blue_button(context, btnTxt, press: () {
                            DateTime dateTime =
                            DateTime.fromMillisecondsSinceEpoch(widget.data["startsAt"] * 1000);
                            DateTime timeFormat = DateTime.now();
                            var timee = DateTime.tryParse(dateTime.toString());
